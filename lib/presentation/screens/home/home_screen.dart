...
import 'package:chatting_application/presentation/screens/chat/chat_message_screen.dart';
import 'package:chatting_application/presentation/widgets/chat_list_tile.dart';
        ...
        actions: [
          InkWell(
            onTap: () async {
              ...
              getIt<AppRouter>().pushAndRemoveUntil(const AuthScreen());
            },
            child: const Icon(
              Icons.logout,
            ),
